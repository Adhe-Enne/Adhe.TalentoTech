          ...
          <div className="row gy-4">
            <div className="col-12 col-md-4">
              ...
              <div aria-hidden className="social-icons d-flex gap-3">
                <a aria-label="GitHub" className="btn btn-outline-primary btn-lg rounded-circle" href="https://github.com/Adhe-enne">
                ...
                <a aria-label="Linkedin" className="btn btn-outline-primary btn-lg rounded-circle" href="https://www.linkedin.com/in/daniel-nina-dev/">
                  <svg fill="currentColor" height="24" viewBox="0 0 24 24" width="24">
